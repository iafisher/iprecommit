...
def main(argv=None):
    argparser = argparse.ArgumentParser(
        description="Check each file (or commit) for common typos."
    )
    ...
    for lineno, line in enumerate(text.splitlines(), start=1):
        ...
        for word in words:
            ...
            if fixes is not None:
                ...
                print(f"  typo on line {lineno}: {word} (did you mean {suggested}?)")

    return found_typo


# Adapted from https://en.wikipedia.org/wiki/Wikipedia:Lists_of_common_misspellings/For_machines
# at version 1199637275.
#
